...
public class ConfigDao extends AbstractDao<Config, Long> {
    ...
    public static class Properties {
        ...
        public final static Property BitmapId = new Property(1, String.class, "bitmapId", false, "BITMAP_ID");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Config entity) {
        ...
        String bitmapId = entity.getBitmapId();
        if (bitmapId != null) {
            stmt.bindString(2, bitmapId);
        }
    }
    ...
    public Config readEntity(Cursor cursor, int offset) {
        Config entity = new Config( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // bitmapId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Config entity, int offset) {
        ...
        entity.setBitmapId(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
